...
<header class="cabecalho">
	...
	<aside class="autenticacao">
		<i title="Sair" id="btnSair" class="icofont-sign-out icofont-2x"></i>
	</aside>
</header>
<body>
<div class="meio">
	<div class="conteudo">
		...
		<div class="barra-op">
			...
			<div class="botao">
				<button id="myBtn" onclick="pop()">Adicionar Item<img src="images/plus.svg" alt=""></button>
			</div>
		</div>
		<div class="tabela">
			<table>
					...
					<?php
						...
						while($dado = $lista->fetch(PDO::FETCH_ASSOC)) {?>
							<tr>
								...
								<td>
									<a href='javascript:confirmarApagarItem(<?php echo $dado["id"];?>);' title="Apagar" class="bnt"><i id="lixo" class="icofont-trash"></i></a> |
									<a href='_controles/processa-acoes-itens.php?acao=Editar&id=<?php echo $dado["id"];?>' title="Editar" class="bnt"><i id="lapis" class="icofont-pencil-alt-5"></i></a>
								</td>
							</tr>
							<?php
						} ?>
...
<div id="myModal" class="modal">
	<div class="modal-content">
		<div class="modal-header">
			...
			<span class="close" title="Fechar"><i class="icofont-close-circled"></i></span>
		</div>
		...
		<div class="modal-footer">
			...
			<button id='cancel'><i class="icofont-not-allowed"></i> Não</button>
		</div>
	</div>
</div>
...
<div id="modalSair" class="modal">
	<div class="modal-content modal-alert">
		<div class="modal-header">
			...
			<span class="close" title="Fechar"><i id="closeSair" class="icofont-close-circled"></i></span>
		</div>
		<div class="modal-footer">
			<button onclick="window.location.href='_controles/sair.php';" id="sair"><i class="icofont-check"></i> Sim</button>
			<button id='cancelSair'><i class="icofont-not-allowed"></i> Não</button>
		</div>
	</div>
</div>
